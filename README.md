...
![Tests](https://img.shields.io/badge/tests-297%20API%20%2B%2033%20E2E-brightgreen)
...
**Infra** — Docker + one-command Docker Compose · Kubernetes manifests ([k8s/](k8s/README.md)) · GitHub Actions CI (tests against a live pgvector service) · **297 API tests + 33 Playwright E2E**, plus lint and typecheck gates

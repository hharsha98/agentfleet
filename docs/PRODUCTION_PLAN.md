...
- **NEXT: rest of Phase 10** — N (voice agent, Vapi — degrades gracefully without VAPI_API_KEY; hidden when absent). Then Phase 11 (O Playwright E2E, P Sentry, pagination, load test).

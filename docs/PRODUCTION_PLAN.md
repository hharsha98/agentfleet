...
- **NEXT: rest of Phase 10** — K (⌘K palette + empty states + changelog) → L (prompt playground + A/B) → M (2nd-SDK / Pydantic AI agent) → N (voice, Vapi). Each degrades gracefully without its key.
